...
public class TimeTableView extends LinearLayout {
    ...
    private String[] weekname = {"Mon.", "Tue.", "Wed.", "Thur.", "Fri.", "Sat.", "Sun."};
        ...
        for (int i = 1; i < startnum; i++) {
            ...
            mTime.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    Toast.makeText(getContext(), "week" + week + "," + (start + num), Toast.LENGTH_LONG).show();
                }
            });
    ...
    private View getMode(final TimeTableModel model) {
        ...
        mTimeTableNameView.setText(model.getName() + "," + model.getClassroom() + "," + model.getTeacher());
